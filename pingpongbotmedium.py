def pingpongbot_medium():
    ...
    def print_info():
        ...
        bot_txt = text_font.render(f"Bot Score: {bot_score}", True, (0, 0, 0))
        screen.blit(score_txt, (50, 30))
        screen.blit(bot_txt, (50, 80))
    ...
    bot_racket = Rackets(0, 0, 135, 135, 10, "racket.png")
    ...
    while game_running:
        ...
        if score == (winning_score - 1) and bot_score == (winning_score - 1):
            winning_score += 1
